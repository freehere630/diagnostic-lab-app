        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              {pendingCount > 0 ? (
                <span className="px-2.5 py-0.5 bg-amber-100 text-amber-800 font-extrabold text-[10px] rounded-full flex items-center gap-1 animate-pulse">
                  <AlertCircle className="w-3 h-3 text-amber-600" /> {pendingCount} Pending Tests
                </span>
              ) : (
                <span className="px-2.5 py-0.5 bg-emerald-100 text-emerald-800 font-bold text-[10px] rounded-full flex items-center gap-1">
                  <CheckCircle2 className="w-3 h-3 text-emerald-600" /> All Caught Up
                </span>
              )}
            </div>
            <p className="text-[11px] text-slate-500 mt-0.5">
              <b>Pending Samples on Top</b> ({pendingCount} pending • {completedCount} verified)
            </p>
          </div>
        </div>
